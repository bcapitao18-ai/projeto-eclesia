...
export default function FormSubsidios({
  editData,
  onFinish,
  onCancelEdit,
}) {
          ...
          >
            ...
            >
              ...
              <Typography variant="h4" sx={{ fontWeight: 900 }}>
                {isEditMode ? "Editar Subsídio" : "Gestão de Subsídios"}
              </Typography>

              <Typography sx={{ opacity: 0.9, mt: 1 }}>
                {isEditMode
                  ? "Atualização de subsídio existente"
